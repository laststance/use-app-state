#  [![CircleCI](https://circleci.com/gh/laststance/use-app-sate.svg?style=svg)](https://circleci.com/gh/laststance/use-app-sate) [![Depfu](https://badges.depfu.com/badges/7c09c0977aa273b25bebc74befdfbee9/overview.svg)](https://depfu.com/github/ryota-murakami/use-app-sate?project_id=9896) [![tested with jest](https://img.shields.io/badge/tested_with-jest-99424f.svg)](https://github.com/facebook/jest) [![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg?style=flat-square)](https://github.com/prettier/prettier) [![All Contributors](https://img.shields.io/badge/all_contributors-2-orange.svg?style=flat-square)](#contributors)

> 🌏 React Global AppState for Sharing Data between each components Built on useContext.
...
import Provider, { useAppState } from '@laststance/use-app-sate'
...
[![Edit use-app-sate-exampe](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/use-app-sate-exampe-oreg7?fontsize=14)

<a href="https://codesandbox.io/s/use-app-sate-example-oreg7">![codesandbox](./images/codesandbox.gif)</a>

[https://use-app-sate-demo.netlify.com/](https://use-app-sate.netlify.com/) Same code as above usage's one.
...
- At the [React + TypeScript Cheatsheets](https://github.com/typescript-cheatsheets/react-typescript-cheatsheet#example-app): Example App Section, [React TypeScript Todo Example 2019](https://github.com/ryota-murakami/react-typescript-todo-example-2019) is created with use-app-sate.

## Articles

- [React AppState was migrated to TypeScript!](https://dev.to/malloc007/use-app-sate-was-migrated-to-typescript-5746)
...
- [I Created React AppState! 🤗](https://dev.to/malloc007/i-created-use-app-sate-2m3k)

## Installation

```
npm install @laststance/use-app-sate
```
...
```js
import Provider from '@laststance/use-app-sate'
...
```js
// example
import { useAppState } from '@laststance/use-app-sate'
...
[![Edit use-app-sate-multiple-appState-example](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/use-app-sate-multiple-appState-example-zwqxd?fontsize=14)
...
<table>
  <tr>
    <td align="center"><a href="http://ryota-murakami.github.io/"><img src="https://avatars1.githubusercontent.com/u/5501268?s=400&u=7bf6b1580b95930980af2588ef0057f3e9ec1ff8&v=4" width="100px;" alt="ryota-murakami"/><br /><sub><b>ryota-murakami</b></sub></a><br /><a href="https://github.com/ryota-murakami/use-app-sate/commits?author=ryota-murakami" title="Code">💻</a> <a href="https://github.com/ryota-murakami/use-app-sate/commits?author=ryota-murakami" title="Documentation">📖</a> <a href="https://github.com/ryota-murakami/use-app-sate/commits?author=ryota-murakami" title="Tests">⚠️</a></td>
    <td align="center"><a href="https://github.com/jackHedaya"><img src="https://avatars0.githubusercontent.com/u/20172754?v=4" width="100px;" alt="Jack Hedaya"/><br /><sub><b>Jack Hedaya</b></sub></a><br /><a href="https://github.com/ryota-murakami/use-app-sate/commits?author=jackHedaya" title="Documentation">📖</a></td>
  </tr>
</table>
